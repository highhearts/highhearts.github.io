...
<div id="container">
  ...
  <div id="mainContent">
    <h1> Press Kit </h1>
    <div class="col">
    <h2> <a href="">High Hearts' One-Sheet</a> </h2>
    <p>Our one-sheet is in PDF format.  Please email contact@highhearts.com for more info.</p>
    <h2> Click on Photo for Hi-Res Version </h2>
